    ...
    <div class="row gx-4 gx-lg-5">
      <div class="col-md-4 mb-5">
        <div>
          ...
          <img class="myImg" src="../Imagenes/Games/nfl1.jpeg" height="400px" width="400px">
      ...
      <div class="col-md-4 mb-5">
        <div>
          <!-- Aplica la clase "myImg" y agrega el evento onclick -->
          <img class="myImg" src="../Imagenes/Games/nfl2.jpeg" height="400px" width="400px">
          <div id="myModal" class="modal">
            <!-- The Close Button -->
            <span class="close">&times;</span>
            <!-- Modal Content (The Image) -->
      ...
      <div class="col-md-4 mb-5">
        <div>
          <!-- Aplica la clase "myImg" y agrega el evento onclick -->
          <img class="myImg" src="../Imagenes/Games/nfl3.jpg" height="400px" width="400px">
          <div id="myModal" class="modal">
            <!-- The Close Button -->
            <span class="close">&times;</span>
            <!-- Modal Content (The Image) -->
